...
def call_oai(schema: dict, label: str, prompt: str = "Generate realistic sample data") -> dict:
...
result_a = call_oai(schema_no_hints, "A_no_hints", 
...
schema_with_hints = {
    "type": "object",
    "properties": {
        "age": {"type": "integer", "description": "Must be between 0 and 150 (inclusive)"},
        "score": {"type": "number", "description": "Must be between 0.0 and 100.0 (inclusive)"},
        "tags": {"type": "array", "items": {"type": "string"}, "description": "Maximum 3 items"},
...
result_b = call_oai(schema_with_hints, "B_with_hints", 
...
result_c = call_oai(schema_opaque, "C_opaque_string",
...
result_d = call_oai(schema_opaque_constrained, "D_opaque_constrained",
