...
Pre-built schema/codec pairs for the [Arazzo 1.0 specification schema](https://spec.openapis.org/arazzo/1.0/schema/2024-08-01), generated by `json-schema-llm`.
...
- **json-schema-llm version**: See `Cargo.toml`
